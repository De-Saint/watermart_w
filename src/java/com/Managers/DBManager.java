...
public static HashMap<String, Integer> GetStringIntHashMap(String outputColumn1, String outputColumn2, String TableName, String Condition) throws ClassNotFoundException, SQLException {
        Connection con = null;
        PreparedStatement stmt = null;
        ResultSet rs = null;
